...
def main_menu(message):
    ...
    markup.add('Создать новый брокерский счет', 'Просмотреть существующие', 'Изменить брокерский счет', 'Аналитика по Дашбордам')  # Добавлена кнопка "Аналитика по Дашбордам"
...
@bot.message_handler(func=lambda message: message.text == "Аналитика по Дашбордам")
